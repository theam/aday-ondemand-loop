...
module Dataverse::Handlers
  class UploadBundleCreateFromDataverse
    ...
    def create(project, request_params)
      ...
      log_info('Creating upload bundle from dataverse', { project_id: project.id, remote_repo_url: remote_repo_url })
      ...
      upload_bundle.save
      log_info('Upload bundle created from dataverse', { bundle_id: upload_bundle.id })
