  ...
  class DataverseDatasetCreate
    def edit(upload_bundle, request_params)
      ...
      if dataverse_data.metadata.subjects.nil?
        dv_metadata_service = DataverseMetadataService.new(connector_metadata.dataverse_url)
      ...
      user_service = DataverseUserService.new(connector_metadata.dataverse_url, api_key: api_key)
    ...
    def update(upload_bundle, request_params)
      ...
      request = DataverseCreateDatasetRequest.new(
      ...
      service = DataverseDatasetService.new(dataverse_url, api_key: api_key)
