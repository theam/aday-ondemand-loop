Rails.application.routes.draw do
  ...
  # ZENODO ROUTES
  post "/view/zenodo/download/dataset" => "zenodo/datasets#download", as: :download_zenodo_dataset_files
  get "/view/zenodo" => "zenodo/landing_page#index", as: :view_zenodo_landing
  get "/view/zenodo/datasets/:record_id" => "zenodo/datasets#show", as: :view_zenodo_dataset, format: false
